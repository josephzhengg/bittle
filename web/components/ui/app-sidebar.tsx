import { Smile, Baby } from 'lucide-react';
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
export function AppSidebar() {
  ...
  return (
    <Sidebar className="border-none bg-transparent overflow-hidden">
      ...
      <SidebarContent className="relative z-10 flex flex-col h-full">
        ...
        <div className="px-6 py-8">
          ...
          <div className="relative mb-8">
            ...
            <div className="relative bg-slate-900/60 backdrop-blur-xl rounded-3xl px-8 py-6 border border-slate-700/30 shadow-2xl">
          ...
          {/* Welcome message */}
          <div className="bg-slate-800/40 backdrop-blur-lg rounded-2xl px-4 py-3 border border-slate-600/20 mb-6">
                ...
                {items.map((item) => {
                  ...
                  return (
                    <SidebarMenuItem key={item.title}>
                      <SidebarMenuButton
                        asChild
                        className="group relative p-0 h-auto bg-transparent hover:bg-transparent w-full focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0">
                        <a
                          href={item.url}
                          className="block w-full outline-none focus:outline-none focus-visible:outline-none focus:ring-0 focus-visible:ring-0">
                          {/* Floating card design */}
                          <div
                            className={` w-full
                            relative overflow-hidden rounded-2xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-1
                            ${
                              isActive
                                ? 'bg-gradient-to-r from-pink-500/30 via-purple-500/30 to-blue-500/30 shadow-2xl shadow-pink-500/25 border border-pink-400/50'
                                : 'bg-slate-800/30 hover:bg-slate-700/50 border border-slate-600/20 hover:border-slate-500/40 shadow-lg hover:shadow-xl hover:shadow-blue-500/10'
                            }
                          `}>
                            {/* Content */}
                            <div className="relative z-10 px-4 py-5">
                              <div className="flex items-center gap-3">
                                ...
                                <div className="flex-1 min-w-0 overflow-hidden">
                                  <span
                                    className={`
                                    block text-lg font-bold transition-all duration-300 text-center truncate
                                    ${
                                      isActive
        ...
        <div className="px-6 py-6 mt-auto">
          ...
          {/* Status indicator */}
          <div className="bg-slate-800/40 backdrop-blur-lg rounded-xl px-4 py-3 border border-slate-600/20">

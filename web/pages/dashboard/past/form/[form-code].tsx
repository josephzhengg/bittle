  ...
  return (
    <DashBoardLayout user={user}>
      <div className="flex flex-col w-full max-w-full mx-auto p-3 sm:p-6 space-y-4 sm:space-y-6">
        ...
        {/* Navigation Tabs */}
        <div className="bg-gray-50/60 backdrop-blur-sm rounded-xl border border-gray-200 p-1">
          <Tabs className="w-full" defaultValue="forms">
            <TabsList className="h-12 p-1 bg-transparent rounded-lg w-full grid grid-cols-2">
              <TabsTrigger
                ...
                className="flex items-center gap-2 h-10 px-3 sm:px-6 rounded-md font-medium transition-all data-[state=active]:bg-gray-100 data-[state=active]:shadow-sm data-[state=active]:text-gray-800 text-gray-500 hover:text-gray-800">
